...
(function (win) {
  var CLODOP = {
    strWebPageID:"C70mt93",strTaskID:"",strHostURI:"http://localhost:8000",
    VERSION:"6.2.2.1",IVERSION:"6221",CVERSION:"3.0.2.9",HTTPS_STATUS:0,VERSION_EXT:false,
    ...
    On_Return:null,Result:null,iTrySendTimes:0,blOneByone:false,DelimChar:"\f\f",Printers:{"default":"0","list":[{"name":"GP-L80250 Series (副本 2)","DriverName":"GP-L80250 Series","PortName":"192.168.199.254","Orientation":"1","PaperSize":"259","PaperLength":"2970","PaperWidth":"720","Copies":"1","DefaultSource":"15","PrintQuality":"203","Color":"1","Duplex":"1","FormName":"","Comment":"","DriverVersion":"1536","DCOrientation":"270","MaxExtentWidth":"720","MaxExtentLength":"32759","MinExtentWidth":"720","MinExtentlength":"2099","pagelist":[{"name":"Gprinter80(72) x 210 mm"},{"name":"Gprinter80(72) x 297 mm"},{"name":"Gprinter80(72) x 3276 mm"}]},{"name":"GP-L80250 Series","DriverName":"GP-L80250 Series","PortName":"192.168.199.254","Orientation":"1","PaperSize":"259","PaperLength":"2970","PaperWidth":"720","Copies":"1","DefaultSource":"15","PrintQuality":"203","Color":"1","Duplex":"1","FormName":"","Comment":"","DriverVersion":"1536","DCOrientation":"270","MaxExtentWidth":"720","MaxExtentLength":"32759","MinExtentWidth":"720","MinExtentlength":"2099","pagelist":[{"name":"Gprinter80(72) x 210 mm"},{"name":"Gprinter80(72) x 297 mm"},{"name":"Gprinter80(72) x 3276 mm"}]}]},
        ...
        if (this.Printers===undefined) return false; else {
          ...
          if (strNameOrNO=="-1") {
            ...
            for(var vNO in this.Printers["list"]){
              var strPrinterName=this.Printers["list"][vNO].name.replace(/\\/g,"");
              if ((strPrinterName==strNameOrNO)||(vNO==strNameOrNO)) {
        ...
        try{
          if (sView && typeof sView === "string"){
            ...
            if (sView === "_dialog" ) {
              ...
              {showModalDialog(strPURL,'dialog','center:yes');}else
    ...
    SelectBox:{
      ...
      create:function(iW,iH,onlySelect){
        ...
        Boxdiv.style.cssText="position:fixed;z-index:91100;display:block;top:2px;border:1px solid #6B97C1;background:#F5F5F5;color:#000;font-size:13px;";
