    ...
    <div class="d2-multiple-page-control-content" flex-box="1">
      <div class="d2-multiple-page-control-content-inner">
        <d2-contextmenu
          ...
          :y="contentmenuY">
          <d2-contextmenu-list
            :menulist="tagName === '/entry' ? contextmenuListIndex : contextmenuList"
...
export default {
  ...
  watch:{
    opened(newVal, oldVal) {
      ...
      //意向学员判断
      newVal.forEach(item => {
        if (item.query.student_inten_type == "last") {
          let newMeta={}
          Object.assign(newMeta,item.meta)
          newMeta.title = "意向学员";
          item.meta=newMeta
        }
      });
  ...
  methods: {
    ...
    handleClick (tab, event) {
      ...
      const { fullPath, name, params, query } = page
      if (page) {
        this.$router.push({ path:fullPath, params, query })
      }
    },
    /**
