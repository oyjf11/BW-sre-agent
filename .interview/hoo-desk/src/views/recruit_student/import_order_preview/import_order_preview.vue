<template>
  <div class="index-wrap">
    <div class="prompt-wrap">
      ...
      <p class="prompt-text">* 模板中<span class="red-text">红色为必录项</span>，"按期收费/按次收费/按月收费三种课程类型</p>
      <p class="prompt-text">* 导入订单后可通过预览，修改或删除错误信息</p>
      <p class="prompt-text">* 一次最多导入<span class="red-text">500条</span>订单，超出的将不显示</p>
    </div>
    <div class="prompt-img">
      <img src="https://image.haoxuezhuli.com/saas-dir/2019-10/1571132881869-378715.png" @click="previewCover">
    </div>
    <div class="prompt-upload text-center">
      <el-upload
        ...
        multiple
      >
        <el-button class="creat_bt" type="primary">导入订单</el-button>
    ...
    <el-dialog
      ...
      <div class="remark_contain">
        <div class="prompt-img">
          <img src="https://image.haoxuezhuli.com/saas-dir/2019-10/1571132881869-378715.png">
        </div>
      </div>
    </el-dialog>
  </div>
...
export default {
  data () {
    return {
      ...
      downloadUrl: "https://image.haoxuezhuli.com/saas-dir/template-file/章鱼校长订单导入模版.xlsx",
