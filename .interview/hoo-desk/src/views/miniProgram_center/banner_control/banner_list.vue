<template>
  <div class="teacher-list">
    ...
    >
      <template slot="table_title">品牌展示</template>
      <el-button slot="buttons" type="primary" @click="toCreated">新增图片</el-button>
      <el-table slot="table" :data="tableData" class="pub-table" v-loading="loading">
        <el-table-column label="图片" width="700">
