<template>
  <div class="teacher-list">
    ...
    >
      <el-button type="primary" slot="buttons" @click="toCreated">新增教师</el-button>
      <template slot="table_title">教师列表</template>
      <el-table slot="table" :data="tableData" v-loading="loading" class="pub-table">
        <el-table-column label="教师名称" width="700">
        ...
        <el-table-column label="教龄" prop="content"></el-table-column>
